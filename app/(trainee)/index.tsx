        ...
        renderItem={({ item }) => {
          ...
          return (
            ...
            >
              ...
              <Text style={styles.cardDesc}>Grupo de estudio supervisado</Text>
...
const makeStyles = (isDark: boolean) => StyleSheet.create({
  ...
  card: { backgroundColor: isDark ? '#1E1E1E' : Colors.surface, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: Colors.info, elevation: 2 },
